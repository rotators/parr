...
int main( int argc, char** argv )  // NOLINT(bugprone-exception-escape)
{
    ...
    try
    {
        ...
        std::cout << std::endl;
        std::cout << "#include <tao/pegtl.hpp>" << std::endl;
        std::cout << "#include <tao/pegtl/contrib/abnf.hpp>" << std::endl;
        std::cout << std::endl;
        std::cout << "namespace parr::rule::ssl" << std::endl;
        std::cout << "{" << std::endl;
        std::cout << "    namespace pegtl = TAO_PEGTL_NAMESPACE;" << std::endl;
        std::cout << "    using namespace pegtl::abnf;" << std::endl;
        std::cout << std::endl;
